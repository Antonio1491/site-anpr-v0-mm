          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mb-8 animate-fade-in-up animation-delay-900">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              <div className="flex items-center justify-center gap-2 text-white">
                ...
                <span className="font-semibold">{eventoReprogramado ? "28 de abril, 2026" : "Miércoles, 25 de febrero"}</span>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              <div className="flex items-center justify-center gap-2 text-white">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="bg-[#012787] text-white p-6 text-center">
                <h3 className="text-2xl font-bold mb-2 font-['Montserrat',sans-serif]">{eventoReprogramado ? "28 de abril, 2026" : "25 de febrero, 2026"}</h3>
