          ...
          <div className="animate-fade-in-up animation-delay-600">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              ...
              <div
                ...
                className={`relative cursor-pointer bg-white backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.25)] p-6 transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] hover:-translate-y-1 flex flex-col text-left text-gray-800 ${
              ...
              >
                {selectedSede === "guadalajara" && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#57d476] text-white text-xs font-bold px-4 py-1 rounded-full shadow-md">
                    Sede seleccionada
                  </div>
                )}
            ...
            <section id="registro" className="px-4 bg-[#012787] text-white text-center py-20 relative overflow-hidden">
              ...
              <div className="max-w-2xl mx-auto relative z-10">
                ...
                <p className="text-lg opacity-90 mb-4">
                  Inscríbete sin costo y acompáñanos en la <strong>5ª Jornada en Guadalajara</strong>. ¡El espacio es limitado!
                </p>
                <p className="text-base font-semibold opacity-95 mb-8">
                ...
                <div className="w-full max-w-lg mx-auto">
                  <div className="flex justify-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 bg-[#57d476] hover:bg-[#45c264] text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all duration-300 hover:scale-105 text-sm"
                    >
                      REGÍSTRATE GRATIS
                      <ChevronRight className="w-4 h-4" />
                    </a>
          ...
          <div className="animate-fade-in-up">
            ...
            <section id="registro" className="px-4 bg-[#012787] text-white text-center py-20 relative overflow-hidden">
              ...
              <div className="max-w-2xl mx-auto relative z-10">
                ...
                <p className="text-lg opacity-90 mb-4">
                  Inscríbete sin costo y acompáñanos en la <strong>6ª Jornada en La Paz</strong>, BCS. ¡El espacio es limitado!
                </p>
                <p className="text-base font-semibold opacity-95 mb-8">
                  ¡Solo 50 lugares disponibles!
                </p>
