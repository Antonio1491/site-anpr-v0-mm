            ...
            <div className="max-w-4xl mx-auto mt-16">
              <ul className="space-y-6">
                ...
                <li className="flex items-center space-x-4">
                  ...
                  <p className="text-lg text-gray-700">
                    <span className="font-bold text-gray-900">Lanzamiento de Voto Social:</span> 09 de marzo 2026
                  </p>
                </li>
                <li className="flex items-center space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-gray-300 text-gray-700 rounded-full font-bold">
                  ...
                  <p className="text-lg text-gray-700">
                    <span className="font-bold text-gray-900">Cierre de Voto Social:</span> 27 de marzo 2026
                  </p>
                </li>
                <li className="flex items-center space-x-4">
                  <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-gray-300 text-gray-700 rounded-full font-bold">
                  ...
                  <p className="text-lg text-gray-700">
                    <span className="font-bold text-gray-900">Resultados:</span> 30 de marzo 2026
                  </p>
                </li>
                <li className="flex items-center space-x-4">
