          ...
          <div className="mb-8 animate-fade-in-up animation-delay-400 relative">
            <div className="flex flex-col items-center">
              <div className="relative inline-block">
                ...
                />
                <span
                  className="text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] xl:text-[12rem] relative z-10 block font-['Montserrat',sans-serif] font-bold not-italic hero-title-normal"
              ...
              <h1
                className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl relative z-10 -mt-2 md:-mt-4 font-['Montserrat',sans-serif] font-black not-italic hero-title-normal"
            ...
            <p
              className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold uppercase tracking-wide mt-4 text-white font-['Montserrat',sans-serif] relative z-20"
